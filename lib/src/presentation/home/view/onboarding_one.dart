...
class OnboardingViewOne extends StatefulWidget {
  const OnboardingViewOne({super.key});

  @override
  State<OnboardingViewOne> createState() => _OnboardingViewOneState();
}

class _OnboardingViewOneState extends State<OnboardingViewOne> {
  @override
